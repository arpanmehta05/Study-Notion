  ...
  return (
    <div>
      <section className="bg-[#2C333F]">
        <div className="relative mx-auto flex w-[90%] max-w-maxContent flex-col justify-between gap-10 text-center text-white">
          ...
          <div className="absolute bottom-0 left-[50%] grid w-[100%] translate-x-[-50%] translate-y-[30%] grid-cols-3 gap-3 lg:gap-5">
            <img src="/aboutus1.webp" alt="" />
            <img src="/aboutus2.webp" alt="" />
            <img src="/aboutus3.webp" alt="" />
          </div>
        </div>
      </section>
      <section className="border-b border-[#2C333F]">
        <div className="mx-auto flex w-[75%] max-w-maxContent flex-col justify-between gap-10 text-[#585D69]">
          <div className="h-[100px] "></div>
          <Quote />
        </div>
      </section>
      <section className="mx-auto flex w-[75%] max-w-maxContent flex-col justify-between gap-10 text-[#585D69]">
        <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
          <div className="my-24 flex lg:w-[50%] flex-col gap-10">
            <h1 className="bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045] bg-clip-text text-[36px] font-semibold text-transparent lg:w-[70%] ">
              Our Founding Story
            </h1>
      ...
      <StatsComponent />
      <section className="mx-auto mt-20 flex w-[80%] max-w-maxContent flex-col justify-between gap-10 text-white">
        <LearningGrid />
        <ContactFormSection />
      </section>
