...
import { FooterLink2 } from "../../../public/footer-links";
...
const Footer = () => {
  return (
    <div className="text-[#161D29]">
      <div className="flex lg:flex-row gap-8 items-center justify-between w-[90%] max-w-maxContent text-[#6E727F] leading-6 mx-auto relative py-14">
      ...
      <div className="flex flex-row items-center justify-between w-[90%] max-w-maxContent text-[#6E727F] mx-auto  pb-14 text-sm">
        {/* Section 1 */}
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center">Made Arpan © {new Date().getFullYear()} Studynotion</div>
        </div>
      </div>
    </div>
  );
